              ...
              <Box style={{ display: "block" }} sx={{ padding: "32px" }}>
                ...
                >
                  <Typography
                    ...
                    variant="h3"
                  >
                    3. Click "Microphone" in the left navigation bar, then make
                    sure that it says "Microphone access for this device is on"
                    (click Change if it's Off)
                  </Typography>
                  <Box
                    sx={{
                      backgroundColor: "rgb(255, 255, 255)",
                ...
                >
                  <Typography
                    ...
                    variant="h3"
                  >
                    4. Scroll down and make sure that "Allow desktop apps to
